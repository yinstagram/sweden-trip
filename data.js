...
{ id:'d0708', date:'7/8', dow:'三', leg:'north', color:'#c98a5e',
  ...
  stops:[
    {n:'Luleå 機場（還車）',ll:[65.5431,22.1219],cat:'還車+機場',note:'Harads→Luleå ~1h+ · 還 Sixt → SK2051 飛 GOT（🔴 tracker 顯示係夜機 21:05→22:45·只見週日·7/8 週三上 flysas.com 確認真有+時間先定還車時間）',o:1},
  ...
  notes:['🔴 SK2051 = 夜機!FlightAware:LLA→GOT 21:05→22:45,而且只見週日飛——7/8 係週三,隨時根本冇呢班!⚠️ 上 flysas.com 揀 7/8 親自確認真有呢班 + 幾點,先買票、先定 Sixt 還車時間。','若真係夜機 → 7/8 = Arctic Bath 玩成日 → 夜機 → ~22:45 到 GOT → WOW 半夜 check-in;Haga/Café Husaren/da Matteo 要改去 7/9 朝早(Volvo 前)或 7/11。','還車前影低車況 + 油/電量;落 GOT → Flygbussarna 入市。'],
...
const TRANSPORT = [
  ...
  {seg:'LLA→GOT', mode:'✈️ SK2051', time:'7/8 🔴 夜機?21:05→22:45', tick:'未買·tracker 只見週日·7/8 週三 flysas.com 查實', s:'todo'},
...
const CHECKLIST = [
  {grp:'🛫 行前必做（數碼準備·最易漏）', items:[
    ...
    '✈️ flysas.com 查實 SK2051 7/8 LLA→GOT 真實時間(tracker 顯示夜機 21:05→22:45·只見週日·7/8 週三未必有班)',
...
const EX = {
 ...
 d0708:{carry:'還車前影低車況+油/電量·機票(等 Sixt 先買 SK2051)',tip:'落 GOT→Flygbussarna 入市→WOW check-in。',pace:'🔴SK2051 tracker 顯示夜機 21:05→22:45·只見週日·7/8 週三未必有→買前上 flysas.com 查實 + Sixt confirm 先買;Harads→Luleå ~1h+揸+還車。'},
...
const BOOK = [
 ...
 {t:'✈️ SK2051 LLA→GOT',s:'todo',d:'7/8',pax:'2 人',price:'~700–1,500 SEK/人（2 人 ~1,400–3,000·未鎖實價）',where:'https://www.flysas.com',wl:'flysas.com',dl:'🔴 tracker 顯示係夜機 21:05→22:45 且只見週日飛——7/8 係週三,上 flysas 揀 7/8 確認真有呢班+時間先買(影響 7/8 成個 Göteborg 安排)·等 Sixt 先買'},
